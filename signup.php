...
<!-- Coded by Craig Lewis ST20317192-->
 <!-- Modified from login to signup by Ezme Clark ST20261632.-->
    ...
    <section>
        ...
        <div class = "container_960">
            <div class = "column_6" id = "container_background">
                ...
                <div id = "input_title"><p>Enter your Username:</p><br></div>

                    <div id = "input_bar">
                <label><input type="email" placeholder="Username"></label>
            ...
            <div class = "column_3" id = "red_button">
                ...
                <button type = "submit" id = "red_button">Log in
                </button>
